          ...
          content.map((c) => {
            ...
            return (
              <li
                ...
                className={
                  c.profile_path
                    ? "pr-2 hover:bg-blue-50/20 hover:dark:bg-slate-800/40 backdrop-filter hover:backdrop-blur rounded-full transition duration-[800ms] ease-in-out cursor-pointer"
                    : ""
                }
              >
                {c.profile_path ? (
